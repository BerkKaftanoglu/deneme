...
class ImageClassifierApp(QMainWindow):
    def __init__(self):
        ...
        theme_btn_layout.addWidget(self.theme_button)
        right_layout.addWidget(theme_btn_container)
    ...
    def add_image_text(self):
        self.canvas.setText("Drag/upload your image")
