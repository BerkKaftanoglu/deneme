...
def evaluate_image(image_path, model_type):
    time.sleep(15)  # Simüle edilmiş uzun süreli işlem
...
class ImageClassifierApp(QMainWindow):
    def __init__(self):
        ...
        self.mobile_model_check = QCheckBox("Mobile Model")
        
        for checkbox in [self.small_model_check, self.large_model_check, self.mobile_model_check]:
    ...
    def get_selected_models(self):
        ...
        if self.mobile_model_check.isChecked():
            selected.append("Mobile Model")
        return selected
