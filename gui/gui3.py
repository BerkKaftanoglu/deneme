...
class ResultPopup(QDialog):
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background-color: #943051; color: white; font-size: 14px;")

        # Layout
        self.layout = QVBoxLayout(self)

        # Label to display the "I'm thinking..." text
        self.thinking_label = QLabel("I'm thinking...", self)
        self.thinking_label.setAlignment(Qt.AlignCenter)
        self.layout.addWidget(self.thinking_label)

        # Label to display the loading GIF
        ...
        self.close_button.setStyleSheet(
            ...
            QPushButton:pressed {
                background-color: #FF4500;  /* Darker when pressed */
            }
            """
        )
        ...
        self.loading_movie = QMovie("loading2.gif")  # Replace with the path to your loading GIF
    ...
    def set_result(self, real_probability, fake_probability):
        ...
        self.thinking_label.hide()  # Hide the "I'm thinking..." text
        self.result_label.show()  # Show the result
        self.close_button.show()  # Show the close button

    def show_loading(self):
        # Show the "I'm thinking..." text and loading GIF
        self.thinking_label.show()
        self.loading_label.show()
        self.loading_movie.start()
        self.result_label.hide()  # Hide the result
        self.close_button.hide()  # Hide the close button
...
class ImageClassifierApp(QMainWindow):
    def __init__(self):
        ...
        self.canvas.setStyleSheet("border: 3px rgba(255,255,255,128);")
